package com.zxy.users.service.impl;

import com.alibaba.fastjson.JSON;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.google.common.collect.Maps;
import com.zxy.entity.BCrypt;
import com.zxy.entity.JwtUtil;
import com.zxy.entity.Result;
import com.zxy.entity.StatusCode;
import com.zxy.users.dao.UserMapper;
import com.zxy.users.pojo.User;
import com.zxy.users.service.UserService;
...
public class UserServiceImpl implements UserService {
  ...
  public int addUserPoints(String username, Integer point) {
    if (StringUtils.isEmpty(username)) {
      throw new RuntimeException("传递参数异常");
    }

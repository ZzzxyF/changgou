...
public class TemplateController {
    ...
    //根据分类查询模板信息，分类表存在template_id
    @GetMapping("/category/{id}")
    public   Result<List<Template>> findByCategoryId(@PathVariable("id") int id){
        List<Template> templates=templateService.findByCategoryId(id);
        return new Result<List<Template>>(true, StatusCode.OK,"查询成功",templates) ;
    }
